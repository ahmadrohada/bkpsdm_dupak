...
$id_dupak = isset($_GET['id_dupak']) ? $_GET['id_dupak'] : '';
?>

<input type="hidden"  id="id_pegawai" >
<input type="hidden" value="<?php echo $id_dupak;?>" id="id_dupak" >
