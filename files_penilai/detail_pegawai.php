...
<table width="93%" border="0" class="data_form">
<tr>
...
<tr>
	...
	<td>:</td>
	<td>
		<input type="text" style="width:230px;" id="jabatan" >
	</td>
...
<tr>
	<td width="15%" colspan="7" align="right">
		...
		<button class="ui-state-default simpan" id="simpan" disabled>SIMPAN</button>
		<button class="ui-state-default close" id="batal" disabled>BATAL</button>
		<button class="ui-state-default ralat" id="ralat" disabled>RALAT DATA</button>
