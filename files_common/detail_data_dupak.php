	...
	$("#ekspor_dupak").click(function(){
        ...
        data:"op=cek_step&no_dupak="+no_dupak,
				...
				if (data[0]=='19'){
						...
						+"Halaman akan dialihkan ke Form Pengajuan PAK <br>dan seluruh data DUPAK akan diekspor ke halaman tersebut</center>"
						);
						...
						buttons: {
							"Lanjutkan": function () {
								window.location.assign("?page=form_pak&no_dupak="+no_dupak);
								$(this).dialog('close');
						},
							"Tutup": function () {
								$(this).dialog('close');
...
<tr>
	<td>
		<button class="ui-state-default lanjut" id="ekspor_dupak" style="margin-left:-10px; width:240px;">BUKA HALAMAN PAK</button>
		<img src="images/loader/load1.gif" id="load_e_dupak" />
	</td>
</tr>
</table>
-->
