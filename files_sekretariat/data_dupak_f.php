		...
		$.ajax({
            ...
            success:function(msg){
				...
				**/
					...
					if ( msg=='11110' ){
						window.location.assign("?page=dupak_ekspor&no_dupak="+no_dupak);
					}else{
						alert("error");
					}
			}
...
DATA DUPAK ( SELESAI TIM PENILAI )
</h3>
...
if( (isset($_POST['cari'])) | (isset($_GET['cari']))){
		...
		//pencarian data
		$page['jika'] = "dt_pegawai.id_pegawai = dt_dupak.id_pegawai and (dt_pegawai.nip_baru = '$txtcari' or nama LIKE '%$txtcari%' or dt_dupak.no_dupak = '$txtcari') and step='19' ";
		$all['jika'] = "dt_pegawai.id_pegawai = dt_dupak.id_pegawai and (dt_pegawai.nip_baru = '$txtcari' or nama LIKE '%$txtcari%' or dt_dupak.no_dupak = '$txtcari') and step='19' ";
		...
		$page['jika'] = "dt_pegawai.id_pegawai = dt_dupak.id_pegawai and step='19' ";
		$all['jika'] = "dt_pegawai.id_pegawai = dt_dupak.id_pegawai and step='19' ";
}
...
<tr>
	...
	<td align="center">
		<a href="#" class="aksi verifikasi" value="<?php echo $r->no_dupak; ?>" >VERIFIKASI</a>
	</td>
</tr>
<?php
$no = $no+1;
